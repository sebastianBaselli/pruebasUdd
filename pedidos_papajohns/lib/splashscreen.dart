...
import 'package:pedidos_papajohns/theme.dart'; // Importa MyTheme desde theme.dart
import 'package:pedidos_papajohns/main.dart'; // Importa MyTheme desde theme.dart
          ...
          return Scaffold(
            ...
            body: Center(
              child: Container(
                ...
                child: Image.asset(
                  'assets/papajohns.png', // Ruta de tu imagen
